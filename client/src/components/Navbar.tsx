...
export default function Navbar({ activeSection = "hero", scrollToSection }: NavbarProps) {
  ...
  const menuItems = [
    ...
    { id: "how-it-works", label: "Saiba Mais" },
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-5">
            ...
            <div className="flex items-center space-x-4 ml-2">
              <a href="https://wa.me/5511938009174" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-70" aria-label="WhatsApp">
