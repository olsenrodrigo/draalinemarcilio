          ...
          <div>
            <div className="flex items-center mb-4">
              <span className="text-xl font-bold text-white">
                Dra.<span style={{ color: "#5B8C9B" }}> Aline Marcilio</span>
              </span>
            </div>
            ...
            <p className="text-sm leading-relaxed mb-1" style={{ color: "rgba(237, 242, 244, 0.7)" }}>
              Especialista em Cirurgia Digestiva, Coloproctologia e Bariátrica.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <a href="https://wa.me/5511938009174" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EDF2F4" }}>
              ...
              <a href="https://www.instagram.com/draaline.alves/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EDF2F4" }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="mailto:contato@draalinealves.com.br" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EDF2F4" }}>
