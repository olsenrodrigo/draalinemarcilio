        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              <a href="https://wa.me/5511933353033" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-base transition-colors hover:text-white" style={{ color: "#EDF2F4" }}>
