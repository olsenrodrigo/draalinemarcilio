 ...
 * Dra. Aline Marcilio não está verificado lá, então o padrão sai de `sintetiza.ai`
...
const REMETENTE_PADRAO = "Site Dra. Aline Marcilio <nao-responda@sintetiza.ai>";
const DESTINO_PADRAO = "contato@draalinemarcilio.com.br";
